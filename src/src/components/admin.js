  ...
  return (
    <div className="admin">
      <div className="input">
        ...
        /> */}
        <br />
        <label className="textfield-label">Twitter</label>
        <input
          type="textfield"
          className="textfield"
          value={twitter}
        ...
        />
        <br />
        <label className="textfield-label">Discord</label>
        <input
          className="textfield"
          value={discord}
          label="Discord"
        ...
        />
        <br />
        <label className="textfield-label">Medium URL</label>
        <input
          className="textfield"
          value={medium}
          label="Medium URL"
        ...
        />
        <br />
        <label className="textfield-label">Collection URL</label>
        <input
          className="textfield"
          value={collectionurl}
        ...
        /> */}
        <label className="textfield-label">Game</label>
        <select
          className="textfield"
          id="games"
          label="Select Games"
        ...
        <br />
        <label className="textfield-label">Give Aways</label>
        <input
          className="textfield"
          value={give}
        ...
        />
        <br />
        <button className="textfield-btn" variant="contained" component="label">
          Upload Image
          <input
            type="file"
            onChange={(e) => {
      ...
      <br />
      <div className="admin-submit-outer">
        <button
